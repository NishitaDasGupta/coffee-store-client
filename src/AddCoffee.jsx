...
const AddCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] m-24 p-7">
            <h2 className="text-center text-3xl font-extrabold">Add a Coffee</h2>
                ...
                <div className="flex mb-2">
                    ...
                    <div className="form-control m-2 md:w-1/2">
                        ...
                        <label className="input-group">
                            ...
                            <input type="text" name="quantity" placeholder="Availabel Quantity" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
                <div className="flex mb-2">
